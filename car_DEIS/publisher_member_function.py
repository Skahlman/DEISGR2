...
class MinimalPublisher(Node):
    ...
    def on_left_stick_y_changed(self, left_stick_y: Number):
        self.leftSpeed = 2*(127.5-left_stick_y)
    ...
    def on_right_stick_y_changed(self, right_stick_y: Number):
        self.rightSpeed = 2*(127.5-right_stick_y)
    ...
    def timer_callback(self):
        msg = String()
        msg.data = 'data: 1/9/2023-11:05:35.859906,g,-1,-1,-2,%i;%i' % (self.leftSpeed, self.rightSpeed)
...
"""class Example:
    ...
    def on_left_stick_y_changed(self, left_stick_y: Number):
        leftSpeed = 2*(127.5-left_stick_y)
        print(f'on_left_stick_y_changed: {left_stick_y}')
    ...
    def on_right_stick_y_changed(self, right_stick_y: Number):
        rightSpeed = 2*(127.5-right_stick_y)
        print(f'on_right_stick_y_changed: {right_stick_y}')
