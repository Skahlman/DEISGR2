...
class Example:
    ...
    def run(self) -> None:
        ...
        while self.is_running:
            #time.sleep(0.1)
            os.system(f'ros2 topic pub -1 /action std_msgs/String \"data: 1/9/2023-11:05:35.859906,g,-1,-1,-2,{self.leftSpeed};{self.rightSpeed}\"')
    ...
    def on_right_stick_y_changed(self, right_stick_y: Number):
        self.rightSpeed = int((127.5-right_stick_y))
